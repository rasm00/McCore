...
public final class CString {
    public static int getIntFromString(java.lang.String s) {
        if (s != null) {
    ...
    public static double getDoubleFromString(java.lang.String s) {
        if (s != null) {
            return Optional.of(s.replaceAll("\\s+", "")
                            .replaceAll("[^-.,0-9]", ""))
                    .filter(s1 -> s1.length() > 0)
    ...
    public static float getFloatFromString(java.lang.String s) {
        if (s != null) {
            return Optional.of(s.replaceAll("\\s+", "")
                            .replaceAll("[^-.,0-9]", ""))
                    .filter(s1 -> s1.length() > 0)
    ...
    public static <K extends Enum<K>> boolean containsEnumFromString(java.lang.String s, Class<K> e) throws IllegalArgumentException {
        Enum<K> anEnum;
        if (s == null) {
            return false;
        }
    ...
    public static <K extends Enum<K>> Optional<K> getEnumValue(java.lang.String s, Class<K> e) {
        if (!containsEnumFromString(s, e)) {
            return Optional.empty();
        }
        return Optional.of(Enum.valueOf(e, s));
    }

    public static Material getMaterialFromString(java.lang.String s) {
        if (s != null) {
            Material material;
            try {
    ...
    public static boolean isBoolean(Object obj) {
        ...
        try {
            ...
            if (obj instanceof java.lang.String) {
                java.lang.String s = ((java.lang.String) obj).toLowerCase();
    ...
    public static List<java.lang.String> copyPartialMatches(java.lang.String token, List<java.lang.String> originals){
